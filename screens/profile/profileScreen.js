...
import { Text, View, StyleSheet, SafeAreaView, StatusBar, ScrollView, TouchableOpacity, Image, Dimensions, Alert, } from "react-native";
...
// annoying pop-up alert *3
Alert.alert('Working on it..','Most of the buttons are currently disabled.')
    ...
    function userInfo() {
        return (
            <TouchableOpacity
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Image
                        source={require('../../assets/images/user_profile/user_5.jpg')}
                        style={{
